/*Pour exécuter ce script, directement avec Node.js :
node index.js
ou le charger dans une page web et inspecter la console.
Remarque:  utilise la syntaxe des fonctions fléchées
*/
